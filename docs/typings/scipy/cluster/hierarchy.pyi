...
def to_tree(Z, rd=...): # -> tuple[ClusterNode | None, Unknown] | ClusterNode | None:
    """
...
def cophenet(Z, Y=...): # -> NDArray[double] | tuple[Unknown, NDArray[double]]:
    """
...
def inconsistent(Z, d=...): # -> NDArray[double]:
    r"""
...
def from_mlab_linkage(Z): # -> NDArray[double]:
    """
...
def dendrogram(Z, p=..., truncate_mode=..., color_threshold=..., get_leaves=..., orientation=..., labels=..., count_sort=..., distance_sort=..., show_leaf_counts=..., no_plot=..., no_labels=..., leaf_font_size=..., leaf_rotation=..., leaf_label_func=..., show_contracted=..., link_color_func=..., ax=..., above_threshold_color=...): # -> dict[str, list[Unknown] | None]:
    """
