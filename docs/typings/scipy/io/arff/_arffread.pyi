...
class NominalAttribute(Attribute):
    ...
    @classmethod
    def parse_attribute(cls, name, attr_string): # -> Self@NominalAttribute | None:
        """
        Parse the attribute line if it knows how. Returns the parsed
        attribute, or None.
...
class NumericAttribute(Attribute):
    ...
    @classmethod
    def parse_attribute(cls, name, attr_string): # -> Self@NumericAttribute | None:
        """
        Parse the attribute line if it knows how. Returns the parsed
        attribute, or None.
...
class StringAttribute(Attribute):
    ...
    @classmethod
    def parse_attribute(cls, name, attr_string): # -> Self@StringAttribute | None:
        """
        Parse the attribute line if it knows how. Returns the parsed
        attribute, or None.
...
class DateAttribute(Attribute):
    ...
    @classmethod
    def parse_attribute(cls, name, attr_string): # -> Self@DateAttribute | None:
        """
        Parse the attribute line if it knows how. Returns the parsed
        attribute, or None.
...
class RelationalAttribute(Attribute):
    ...
    @classmethod
    def parse_attribute(cls, name, attr_string): # -> Self@RelationalAttribute | None:
        """
        Parse the attribute line if it knows how. Returns the parsed
        attribute, or None.
...
def split_data_line(line, dialect=...): # -> tuple[list[str], Type[Dialect] | Unknown]:
    ...

def tokenize_attribute(iterable, attribute): # -> tuple[NominalAttribute | NumericAttribute | DateAttribute | StringAttribute | RelationalAttribute, Unknown]:
...
def read_header(ofile): # -> tuple[str | Any | None, list[Unknown]]:
...
class MetaData:
    ...
    def __getitem__(self, key): # -> tuple[Unknown, Unknown]:
        ...
...
def basic_stats(data): # -> tuple[Unknown, Unknown, floating[Any], Unknown]:
    ...
