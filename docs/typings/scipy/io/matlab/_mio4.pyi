...
class VarReader4:
    ...
    def array_from_header(self, hdr, process=...): # -> coo_matrix | NDArray[complexfloating[Any, Any]] | ndarray[Unknown, Unknown]:
        ...
    
    def read_sub_array(self, hdr, copy=...): # -> ndarray[Unknown, Unknown]:
    ...
    def read_full_array(self, hdr): # -> NDArray[complexfloating[Any, Any]] | ndarray[Unknown, Unknown]:
    ...
    def read_char_array(self, hdr): # -> ndarray[Unknown, Unknown]:
...
class MatFile4Reader(MatFileReader):
    ...
    def read_var_array(self, header, process=...): # -> coo_matrix | NDArray[complexfloating[Any, Any]] | ndarray[Unknown, Unknown]:
