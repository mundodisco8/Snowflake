...
class spmatrix:
    ...
    def __sub__(self, other): # -> Self@spmatrix | NDArray[Any] | _NotImplementedType:
        ...
    ...
    def __pow__(self, other): # -> dia_array | csr_matrix | csc_matrix | coo_matrix | dia_matrix | Any | Self@spmatrix | _NotImplementedType:
        ...
