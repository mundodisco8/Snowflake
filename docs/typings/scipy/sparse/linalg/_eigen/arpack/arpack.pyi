...
_ARPACK_LOCK = ...
def eigs(A, k=..., M=..., sigma=..., which=..., v0=..., ncv=..., maxiter=..., tol=..., return_eigenvectors=..., Minv=..., OPinv=..., OPpart=...): # -> NDArray[Unknown] | tuple[NDArray[Unknown] | Unknown, NDArray[Unknown] | Unknown, NDArray[Unknown] | Unknown] | tuple[NDArray[Unknown] | Unknown, NDArray[Unknown] | Unknown] | tuple[Unknown, Unknown]:
    """
...
def eigsh(A, k=..., M=..., sigma=..., which=..., v0=..., ncv=..., maxiter=..., tol=..., return_eigenvectors=..., Minv=..., OPinv=..., mode=...): # -> tuple[Any | Unknown | ndarray[Any, _dtype], Any | Unknown | NDArray[Unknown]] | ndarray[Any, _dtype] | tuple[Unknown, Unknown]:
    """
