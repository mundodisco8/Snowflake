...
"""
__all__ = ['onenormest']
def onenormest(A, t=..., itmax=..., compute_v=..., compute_w=...): # -> tuple[Any | Unknown | Literal[0], NDArray[Any], ndarray[Any, dtype[Unknown]]] | tuple[Any | Unknown | Literal[0], ndarray[Any, dtype[Unknown]]] | tuple[Any | Unknown | Literal[0], NDArray[Any]] | tuple[Any | Unknown | Literal[0]] | Any | Literal[0]:
    """
