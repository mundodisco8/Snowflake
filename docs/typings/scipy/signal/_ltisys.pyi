...
class lti(LinearTimeInvariant):
    ...
    *system : arguments
    ...
    """
    def __new__(cls, *system): # -> TransferFunctionContinuous | ZerosPolesGainContinuous | StateSpaceContinuous | Self@lti:
    ...
    def impulse(self, X0=..., T=..., N=...): # -> tuple[NDArray[floating[Any]] | NDArray[Unknown], Any | NDArray[Any]]:
        """
    ...
    def step(self, X0=..., T=..., N=...): # -> tuple[NDArray[Unknown] | NDArray[floating[Any]], Any | NDArray[Any]]:
        """
    ...
    def output(self, U, T, X0=...): # -> tuple[NDArray[Unknown], Any, NDArray[Unknown]] | tuple[NDArray[floating[Any]], NDArray[Any], Unknown]:
        """
    ...
    def bode(self, w=..., n=...): # -> tuple[NDArray[floating[Any]] | NDArray[Any] | Unknown | None, NDArray[floating[Any]], NDArray[floating[Any]]]:
        """
    ...
    def freqresp(self, w=..., n=...): # -> tuple[NDArray[floating[Any]] | NDArray[Any] | Unknown | None, NDArray[complexfloating[Any, Any]] | Unknown | Unbound]:
        """
...
class dlti(LinearTimeInvariant):
    ...
    *system: arguments
    ...
    """
    def __new__(cls, *system, **kwargs): # -> TransferFunctionDiscrete | ZerosPolesGainDiscrete | StateSpaceDiscrete | Self@dlti:
        """Create an instance of the appropriate subclass."""
        ...
    ...
    def impulse(self, x0=..., t=..., n=...): # -> tuple[Unbound | NDArray[floating[Any]], tuple[NDArray[float64]] | tuple[NDArray[float64], NDArray[float64]] | tuple[NDArray[float64], NDArray[float64], NDArray[float64]] | None]:
        """
    ...
    def step(self, x0=..., t=..., n=...): # -> tuple[Unbound | NDArray[floating[Any]], tuple[NDArray[float64]] | tuple[NDArray[float64], NDArray[float64]] | tuple[NDArray[float64], NDArray[float64], NDArray[float64]] | None]:
        """
    ...
    def output(self, u, t, x0=...): # -> tuple[NDArray[floating[Any]], NDArray[float64], NDArray[float64]] | tuple[NDArray[floating[Any]], NDArray[float64]]:
        """
    ...
    def bode(self, w=..., n=...): # -> tuple[Unknown, NDArray[floating[Any]], NDArray[Any]]:
        r"""
    ...
    def freqresp(self, w=..., n=..., whole=...): # -> tuple[NDArray[floating[Any]] | Unknown | None, Unknown | NDArray[Any] | Any | Unbound]:
        """
...
class TransferFunction(LinearTimeInvariant):
    ...
    *system: arguments
    ...
    """
    def __new__(cls, *system, **kwargs): # -> Self@TransferFunction:
    ...
    @property
    def num(self): # -> NDArray[Unknown] | None:
    ...
    @property
    def den(self): # -> NDArray[Unknown] | None:
...
class ZerosPolesGain(LinearTimeInvariant):
    ...
    *system : arguments
    ...
    """
    def __new__(cls, *system, **kwargs): # -> Self@ZerosPolesGain:
        """Handle object conversion if input is an instance of `lti`"""
        ...
    ...
    @property
    def zeros(self): # -> NDArray[Unknown] | None:
    ...
    @property
    def poles(self): # -> NDArray[Unknown] | None:
...
class StateSpace(LinearTimeInvariant):
    ...
    *system: arguments
    ...
    __array_priority__ = ...
    __array_ufunc__ = ...
    def __new__(cls, *system, **kwargs): # -> Self@StateSpace:
    ...
    @property
    def A(self): # -> NDArray[Unknown] | None:
    ...
    @property
    def B(self): # -> NDArray[Unknown] | None:
    ...
    @property
    def C(self): # -> NDArray[Unknown] | None:
    ...
    @property
    def D(self): # -> NDArray[Unknown] | None:
...
def lsim2(system, U=..., T=..., X0=..., **kwargs): # -> tuple[NDArray[floating[Any]], NDArray[Any], Unknown]:
    """
...
def lsim(system, U, T, X0=..., interp=...): # -> tuple[NDArray[Unknown], Any, NDArray[Unknown]] | tuple[NDArray[floating[Any]], NDArray[Any], Unknown]:
    """
...
def impulse(system, X0=..., T=..., N=...): # -> tuple[NDArray[floating[Any]] | NDArray[Unknown], Any | NDArray[Any]]:
...
def step(system, X0=..., T=..., N=...): # -> tuple[NDArray[Unknown] | NDArray[floating[Any]], Any | NDArray[Any]]:
...
def bode(system, w=..., n=...): # -> tuple[NDArray[floating[Any]] | NDArray[Any] | Unknown | None, NDArray[floating[Any]], NDArray[floating[Any]]]:
    """
    Calculate Bode magnitude and phase data of a continuous-time system.
...
def freqresp(system, w=..., n=...): # -> tuple[NDArray[floating[Any]] | NDArray[Any] | Unknown | None, NDArray[complexfloating[Any, Any]] | Unknown | Unbound]:
...
def dlsim(system, u, t=..., x0=...): # -> tuple[NDArray[floating[Any]], NDArray[float64], NDArray[float64]] | tuple[NDArray[floating[Any]], NDArray[float64]]:
    """
...
def dimpulse(system, x0=..., t=..., n=...): # -> tuple[Unbound | NDArray[floating[Any]], tuple[NDArray[float64]] | Unknown | None]:
    """
...
def dstep(system, x0=..., t=..., n=...): # -> tuple[Unbound | NDArray[floating[Any]], tuple[NDArray[float64]] | Unknown | None]:
    """
...
def dfreqresp(system, w=..., n=..., whole=...): # -> tuple[NDArray[floating[Any]] | Unknown | None, Unknown | NDArray[Any] | Any | Unbound]:
    r"""
    Calculate the frequency response of a discrete-time system.
...
def dbode(system, w=..., n=...): # -> tuple[Unknown, NDArray[floating[Any]], NDArray[Any]]:
    r"""
    Calculate Bode magnitude and phase data of a discrete-time system.
