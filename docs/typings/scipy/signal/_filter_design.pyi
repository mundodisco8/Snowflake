...
abs = ...
def findfreqs(num, den, N, kind=...): # -> NDArray[floating[Any]]:
    """
...
def freqs(b, a, worN=..., plot=...): # -> tuple[NDArray[floating[Any]] | NDArray[Any], NDArray[complexfloating[Any, Any]]]:
    """
...
def freqs_zpk(z, p, k, worN=...): # -> tuple[NDArray[Any], Unknown]:
    """
    Compute frequency response of analog filter.
...
def freqz(b, a=..., worN=..., whole=..., plot=..., fs=..., include_nyquist=...): # -> tuple[NDArray[floating[Any]], Unknown | NDArray[Any] | Any]:
    """
...
def sosfreqz(sos, worN=..., whole=..., fs=...): # -> tuple[Unbound | NDArray[floating[Any]], float | Unknown | NDArray[floating[Any]] | Any]:
    r"""
...
def zpk2tf(z, p, k): # -> tuple[ndarray[Any, _dtype], ndarray[Any, _dtype]]:
    """
...
def sos2tf(sos): # -> tuple[NDArray[float64] | NDArray[floating[Any]], NDArray[float64] | NDArray[floating[Any]]]:
    """
...
def sos2zpk(sos): # -> tuple[NDArray[complex128], NDArray[complex128], float | Any]:
    """
...
def bilinear_zpk(z, p, k, fs): # -> tuple[NDArray[Any], Unknown, Unknown]:
    r"""
    Return a digital IIR filter from an analog one using a bilinear transform.
...
def lp2hp_zpk(z, p, k, wo=...): # -> tuple[NDArray[Any], NDArray[floating[Any]], Unknown]:
    r"""
    Transform a lowpass filter prototype to a highpass filter.
...
def lp2bp_zpk(z, p, k, wo=..., bw=...): # -> tuple[NDArray[Any], NDArray[bool_], Unknown]:
    r"""
    Transform a lowpass filter prototype to a bandpass filter.
...
def lp2bs_zpk(z, p, k, wo=..., bw=...): # -> tuple[NDArray[Any], NDArray[bool_], Unknown]:
    r"""
    Transform a lowpass filter prototype to a bandstop filter.
...
def buttord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Unknown | Any | NDArray[floating[Any]] | NDArray[Any]]:
...
def cheb1ord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Unknown | Any | NDArray[floating[Any]] | NDArray[Any]]:
...
def cheb2ord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Unknown | Any | NDArray[floating[Any]] | NDArray[Any]]:
...
_POW10_LOG10 = ...
def ellipord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Unknown | Any | NDArray[floating[Any]] | NDArray[Any]]:
...
def cheb1ap(N, rp): # -> tuple[NDArray[Any], NDArray[Any], Unknown] | tuple[NDArray[Any], Any, Any]:
    """
...
_ELLIPDEG_MMAX = ...
_ARC_JAC_SN_MAXITER = ...
def ellipap(N, rp, rs): # -> tuple[NDArray[Any], NDArray[Any], Unknown] | tuple[NDArray[Unknown], NDArray[Any], Any] | tuple[NDArray[Any], NDArray[Any], Any]:
...
def gammatone(freq, ftype, order=..., numtaps=..., fs=...): # -> tuple[NDArray[floating[Any]] | NDArray[float64] | Unbound, list[float] | NDArray[float64] | Unbound]:
    """
