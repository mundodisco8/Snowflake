...
def find_peaks(x, height=..., threshold=..., distance=..., prominence=..., width=..., wlen=..., rel_height=..., plateau_size=...): # -> tuple[Unknown, dict[Unknown, Unknown]]:
    """
    Find peaks inside a signal based on peak properties.
...
def find_peaks_cwt(vector, widths, wavelet=..., max_distances=..., gap_thresh=..., min_length=..., min_snr=..., noise_perc=..., window_size=...): # -> NDArray[Unknown]:
    """
