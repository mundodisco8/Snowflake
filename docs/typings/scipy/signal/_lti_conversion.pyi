...
def ss2tf(A, B, C, D, input=...): # -> tuple[NDArray[float64], NDArray[floating[Any]] | list[Unknown] | Literal[1]] | tuple[NDArray[floating[Any]], NDArray[floating[Any]] | Literal[1]]:
...
def cont2discrete(system, dt, method=..., alpha=...): # -> tuple[NDArray[float64], NDArray[floating[Any]] | list[Unknown] | Literal[1], Unknown] | tuple[NDArray[floating[Any]], NDArray[floating[Any]] | Literal[1], Unknown] | tuple[NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]], NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]], Any, Unknown] | tuple[NDArray[float_] | Unknown | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[Unknown]] | ndarray[Any, _dtype], NDArray[float_] | Unknown | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[Unknown]] | ndarray[Any, _dtype] | NDArray[bool_], NDArray[float_] | Unknown, Unknown, Unknown]:
    """
