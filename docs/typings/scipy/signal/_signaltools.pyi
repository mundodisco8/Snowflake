...
def correlation_lags(in1_len, in2_len, mode=...): # -> NDArray[signedinteger[Any]]:
    r"""
...
def deconvolve(signal, divisor): # -> tuple[ndarray[Any, dtype[Any]] | tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]] | Unknown | list[Unknown], NDArray[Unknown] | NDArray[Any] | Unknown]:
...
def cmplx_sort(p): # -> tuple[NDArray[Unknown], NDArray[intp]]:
...
def unique_roots(p, tol=..., rtype=...): # -> tuple[NDArray[Unknown], NDArray[Unknown]]:
...
def invres(r, p, k, tol=..., rtype=...): # -> tuple[NDArray[bool_] | poly1d | Literal[0], NDArray[Any] | NDArray[bool_]]:
...
def residue(b, a, tol=..., rtype=...): # -> tuple[NDArray[float64], NDArray[Unknown], NDArray[Any]] | tuple[Any, NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]], NDArray[float64] | NDArray[floating[Any]]]:
...
def residuez(b, a, tol=..., rtype=...): # -> tuple[NDArray[float64], NDArray[Unknown], NDArray[Any]] | tuple[Any, NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]], ndarray[Any, dtype[float64]] | ndarray[Any, dtype[floating[Any]]]]:
...
def invresz(r, p, k, tol=..., rtype=...): # -> tuple[ndarray[Any, dtype[bool_]] | Any | Unknown, NDArray[Any] | NDArray[bool_]]:
...
def resample(x, num, t=..., axis=..., window=..., domain=...): # -> tuple[Unknown, Unknown]:
    """
...
def resample_poly(x, up, down, axis=..., window=..., padtype=..., cval=...): # -> NDArray[Unknown] | Any | NDArray[bool_] | ndarray[Any, dtype[Any]]:
    """
...
def vectorstrength(events, period): # -> tuple[Any, Unknown | floating[Any]]:
    '''
...
def lfilter_zi(b, a): # -> NDArray[floating[Any]]:
    """
...
def sosfilt_zi(sos): # -> NDArray[float64]:
    """
...
def decimate(x, q, n=..., ftype=..., axis=..., zero_phase=...): # -> ndarray[Any, dtype[Unknown]] | Any | ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[Any]]:
    """
