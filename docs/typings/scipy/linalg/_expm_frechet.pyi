...
def expm_frechet(A, E, method=..., compute_expm=..., check_finite=...): # -> tuple[Unknown | Any | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[Unknown]] | ndarray[Any, _dtype], Unknown | Any | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[Unknown]] | ndarray[Any, _dtype]] | Any | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[Unknown]] | ndarray[Any, _dtype]:
    """
...
def expm_frechet_block_enlarge(A, E): # -> tuple[ndarray[Any, dtype[Any]] | ndarray[Any, dtype[Unknown]] | ndarray[Any, _dtype], ndarray[Any, dtype[Any]] | ndarray[Any, dtype[Unknown]] | ndarray[Any, _dtype]]:
    """
