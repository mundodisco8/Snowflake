...
class SHGO:
    ...
    def sorted_samples(self): # -> tuple[NDArray[intp], Any | Unknown]:
    ...
    def minimizers_1D(self): # -> ndarray[Any, Unknown] | Any | list[Unknown]:
        """
    ...
    def delaunay_minimizers(self): # -> ndarray[Any, Unknown] | Any | list[Unknown]:
        """
        Returns the indices of all minimizers
        """
        ...
