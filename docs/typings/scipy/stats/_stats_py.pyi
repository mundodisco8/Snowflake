...
def moment(a, moment=..., axis=..., nan_policy=...): # -> float64 | NDArray[floating[Any]] | floating[Any] | NDArray[float64]:
...
def trim1(a, proportiontocut, tail=..., axis=...): # -> ndarray[Any, dtype[Unknown]] | list[Unknown]:
...
def fisher_exact(table, alternative=...): # -> tuple[float, float] | tuple[Any | float, float] | tuple[Any | float, Any | NDArray[Any]]:
...
SpearmanrResult = ...
def spearmanr(a, b=..., axis=..., nan_policy=..., alternative=...): # -> SpearmanrResult:
...
WeightedTauResult = ...
def weightedtau(x, y, rank=..., weigher=..., additive=...): # -> WeightedTauResult:
...
MGCResult = ...
def multiscale_graphcorr(x, y, compute_distance=..., reps=..., workers=..., is_twosamp=..., random_state=...): # -> MGCResult:
...
@_rename_parameter("mode", "method")
def kstest(rvs, cdf, args=..., N=..., alternative=..., method=...): # -> KstestResult:
    """
...
def combine_pvalues(pvalues, method=..., weights=...): # -> tuple[Any | Unknown, Any | NDArray[Any]]:
    """
...
def rankdata(a, method=..., *, axis=...): # -> NDArray[float64 | int_] | NDArray[Unknown] | NDArray[signedinteger[Any]] | Any:
