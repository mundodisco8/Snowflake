...
class RegularGridInterpolator:
    ...
    **Interpolate and extrapolate a 2D dataset**
    ...
    def __call__(self, xi, method=...): # -> ndarray[Any, dtype[floating[Any]]] | Any | ndarray[Any, dtype[Any]]:
        """
...
def interpn(points, values, xi, method=..., bounds_error=..., fill_value=...): # -> ndarray[Any, dtype[floating[Any]]] | Any | ndarray[Any, dtype[Any]] | None:
    """
